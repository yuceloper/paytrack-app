  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: const [
          Text('Merhaba 👋', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w700)),
          SizedBox(height: 6),
          Text('Yaklaşan ödemelerini tek yerden takip et.'),
          SizedBox(height: 24),
          _SummaryCard(title: 'Bu ay ödenecek', value: '₺31.420', subtitle: 'Toplam planlanan ödeme'),
          SizedBox(height: 12),
          _SummaryCard(title: 'Önümüzdeki 7 gün', value: '₺18.550', subtitle: '3 yaklaşan ödeme'),
          SizedBox(height: 28),
          Text('Yaklaşan ödemeler', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700)),
          SizedBox(height: 12),
